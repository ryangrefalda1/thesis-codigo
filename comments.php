    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    <i class="fas fa-align-left primary-text fs-4 me-3" id="menu-toggle" style="color:#ffffff"></i>
                     <div class="page-heading"><h2 class="fs-2 m-0">Comments</h2></div>    
                </div>
            ...
            <div class="container-fluid px-4">
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">User Comments  <button title="Refresh" id = "refreshComment"class="btn btn-link" ><i class="fa-solid fa-arrows-rotate" style="color: #3a833a;"></i></button></h3>  
                    <div class="col">
                        <table  id = "commentTable" class="table bg-white rounded shadow-sm  table-hover">
                            <thead>
                                <tr>
            ...
            <div class = "text-center d-grid gap-2 col-3 mx-auto">
                <input type="button" id="showMoreComment" value="Show More Comments" class="btn btn-success" style ="margin-top:-8%">
            </div>
...
// function that ensures that the user will be granted the same userID and token when accessing pages in the sidebar

            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    <i class="fas fa-align-left primary-text fs-4 me-3" id="menu-toggle" style="color:#ffffff"></i>
                     <div class="page-heading"><h2 class="fs-2 m-0"> Admin Dashboard</h2></div>    
                </div>
...
<!-- Update Data Modal -->
<div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="myUpdateModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="UpdateModalLabel">Update Save Profile</h5>
            ...
            <div class="alert alert-primary d-flex align-items-center" role="alert">
                <div>
                <p><b>Note: </b>Updating data without changing any values will result in error</p>
                </div>
            </div>
                ...
                <form id = "updateDataForm">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="userID" name="userID" placeholder="Enter New User ID" />
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Current Health</label>
                        <input type="text" class="form-control" id="currentHealth" name="currentHealth" placeholder="Enter New Current Health" />
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Max Health</label>
                        <input type="text" class="form-control" id="maxHealth" name="maxHealth" placeholder="Enter New Current Health Max Health" />
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Second Current Health</label>
                        <input type="text" class="form-control" id="secondCurrentHealth" name="secondCurrentHealth" placeholder="Enter New Second Current Health" />
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Second Max Health</label>
                        <input type="text" class="form-control" id="secondMaxHealth" name="secondMaxHealth" placeholder="Enter New Second Max Health " />
                    </div>
                    <div class="mb-3">
                        <label class="form-label">HearthShield</label>
                        <input type="text" class="form-control" id="heartshield" name="heartshield" placeholder="Health Limit is 10" />
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Current Room</label>
                        <input type="text" class="form-control" id="currentRoom" name="currentRoom" placeholder="Level Limit is 7" />
                    </div>
                    
                    <div class="mb-3">
                        <label class="form-label">Save Profile Name</label>
                        <input type="text" class="form-control" id="saveName" name="saveName" placeholder="Enter New Save Profile Name" />
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <a class="btn btn-secondary"  data-bs-dismiss ="modal" role="button">Cancel</a>
                <a class="btn btn-success"  id = "updateButton"  data-bs-toggle="modal" data-bs-target="#confirmUpdateModal" role="button">Update</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="confirmUpdateModal" tabindex="-1" aria-labelledby="confirmUpdateModal" aria-hidden="true">
    <div class="modal-dialog modal-sm ">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="confirmUpdateModalTitle">Confirmation</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-success" id = "confirmUpdateModalBttn">Yes</button>
        </div>
      </div>
    </div>
</div>
...
<div class="modal fade" id="confirmSuspendModal" tabindex="-1" aria-labelledby="confirmSuspendModal" aria-hidden="true">
    <div class="modal-dialog modal-sm ">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">No</button>
          <button type="button" class="btn btn-success" id = "confirmSuspendModalBttn">Yes</button>
        </div>
      </div>
    </div>
</div>
